...
\section{Erstellung wissenschaftlicher Dokumente}\label{}
 
In erster Linie soll das System Autoren bei der Erstellung hochwertiger wissenschaftlicher Arbeiten helfen.

 
\begin{itemize}

\item Einführung/Motivation/Szenario/Ziel
\item Erhoffte Verbesserung/Nutzen
\item Beschreiben wie die allgemeine Nutzung ablaufen soll; Bedienvorteile
\item Gibt es Modelle? Wird Semantik explizit sichtbar gemacht? Besser für die Konsistenz?
\end{itemize}
 
\section{UIMA CAS Editor}\label{}
 
Edit me!

 
\section{Dokumentation von Spray-Modellen}\label{}
...
\section{Transformation in andere Formate}\label{}
 
Das wird immer gebraucht! Dokumente für Langzeitarchive rüsten, neue Formatkonventionen -> Update auf aktuelle Version -> Lesbarkeit für aktuelle Programmversionen, alte Formatkonventionen -> Lesbarkeit für lagacy Programmversionen, Verwendung anderer Datenmodelle / Datenbanken, Dokument auf Anwendungsgebiet spezialisieren (z.B. zum Lesen, zum Bearbeiten, für Knowledge Discovery / Semantic Web / Data Mining, Ausrichtung an bestimmte Leserschaft/Publikum), eBooks
