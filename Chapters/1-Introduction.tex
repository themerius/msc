...
Um die Software benutzbar zu machen:\todo{Besser? Weiche Anforderungen? Benutzbarkeit / Bequemlichkeitsfunktionen}
...
\begin{itemize}
  ...
  \item Es soll also ein "lebendiges" Dokument werden, d.h. es sollen keine Kompilierzeiten um das Dokument zu erstellen entstehen
  ...
  \item Es soll ein einheimischer des WWW werden, d.h. Web Standards übernehmen das Setzen des Dokuments, bieten dem Benutzer eine Editierschnittstelle, ermöglichen Kollaboration und bieten eine ubiquitäre Wissensrepräsentation.
\end{itemize}
