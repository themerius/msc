...
\newglossaryentry{glossar.refactor}
{
  name=Refactoring,
...
\newglossaryentry{glossar.semanticweb}
{
  name=Semantic Web,
...
\newacronym{glossar.pdf}{PDF}{Portable Document Format. Ein standardisiertes Format für (paginierte) Dokumente}
