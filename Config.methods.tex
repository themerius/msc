...
because they use often formal models of a specifig domain, like chemical molecules.
But todays systems don't interact with these models, which oftens leads
to inconsisty within the document.
In this work a document editor prototype is developed,
which introduces domain specific document elements,
to enable direct usage of such models within the document.
Document elements (e.g. paragraphs, figures, etc.) could represend
domain specific content, such as a molecule.
If a document elements refers to another,
it can directly access model attributes of the other, like the name of the molecule.
